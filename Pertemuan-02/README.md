...
| 3 | `<hobi>Programming</hobi> <hobi>Membaca</hobi>` | Elemen hobi ganda langsung berada di bawah root tanpa adanya parent pembungkus untuk mengelompokkan daftar hobi tersebut. | `<hobi><hobi>Programming</hobi><hobi>Membaca</hobi></hobi>` |
